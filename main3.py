...
from autoencoder import AutoEncodedClassifier
from autoencoder import AutoEncodedRegressor
...
if __name__ == '__main__':
    ...
    ae = AutoEncodedRegressor(encode_learn_rate=0.01, learn_rate=0.0001, num_encoding=9, num_hidden1=5)
    ...
    # ae = AutoEncodedClassifier(learn_rate=0.0001, num_encoding=4, num_hidden1=3)
    ...
    #
    # # now feed it into the classifier
    # ae = AutoEncodedClassifier(learn_rate=0.01, num_encoding=5, num_hidden1=3)
    ...
    # ae = AutoEncodedRegressor(learn_rate=0.01, num_encoding=6, num_hidden1=3)
    ...
    #
    # ae = AutoEncodedClassifier(learn_rate=0.01, num_encoding=8, num_hidden1=3)
    ...
    # ae = AutoEncodedRegressor(learn_rate=0.01, num_encoding=3, num_hidden1=3)
