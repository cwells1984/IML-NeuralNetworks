...
if __name__ == '__main__':
    ...
    lr = LinearRegressor(learn_rate=0.01, reg_value=0.6)
    ...
    lr_reg = LinearClassifier(learn_rate=0.01, reg_value=0.6)
    ...
    lr = LinearMultiClassifier(learn_rate=0.01, reg_value=0.6)
    ...
    lr_reg = LinearClassifier(learn_rate=0.01, reg_value=0.05)
    ...
    lr = LinearRegressor(learn_rate=0.01, reg_value=0.1)
